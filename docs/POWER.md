...
|------|------|--------:|-----:|-------|
| VPA  | E21 PA, TX | — | **0.6–0.8 A** | 1 W out, PA efficiency-limited; verify |
| VPA  | E21 LNA, RX | ~30–60 mA | — | RX path bias |
| +3V3 | MM8108 | ~0.15–0.4 A | higher in burst | SoC digital + RF (ext-PA, so no internal PA load) — confirm with MM8108 datasheet |
| +3V3 | NEO-M9N | ~25–30 mA | ~70 mA acq | GNSS acquisition peak |
